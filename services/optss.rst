...
.. _ss-server-v1.2.2: https://github.com/wesion100g/optimized-ss/releases/tag/v1.2.2
...
.. code-block:: console
   ...
   $ wget https://github.com/wesion100g/optimized-ss/releases/download/v1.2.2/ss-server-v1.2.2.tar.gz
